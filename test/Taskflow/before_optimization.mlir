module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @main() -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %17 = "taskflow.definition"(%cast_3, %16) : (memref<?xi8>, !llvm.ptr) -> memref<?xi8>
    %18 = "polygeist.pointer2memref"(%16) : (!llvm.ptr) -> memref<?x!llvm.func<void ()>>
    %19 = call @_ZN11taskflowLib15task_definitionEPvPFvvE(%cast, %cast_3, %18) : (memref<?x2xmemref<?xi8>>, memref<?xi8>, memref<?x!llvm.func<void ()>>) -> memref<?xi8>
    %cast_4 = memref.cast %alloca_1 : memref<2xi8> to memref<?xi8>
    %20 = "polygeist.get_func"() <{name = @_Z5funcBv}> : () -> !llvm.ptr
    %21 = "taskflow.definition"(%cast_4, %20) : (memref<?xi8>, !llvm.ptr) -> memref<?xi8>
    %22 = "polygeist.pointer2memref"(%20) : (!llvm.ptr) -> memref<?x!llvm.func<void ()>>
    %23 = call @_ZN11taskflowLib15task_definitionEPvPFvvE(%cast, %cast_4, %22) : (memref<?x2xmemref<?xi8>>, memref<?xi8>, memref<?x!llvm.func<void ()>>) -> memref<?xi8>
    %cast_5 = memref.cast %alloca_0 : memref<2xi8> to memref<?xi8>
    %24 = "polygeist.get_func"() <{name = @_Z5funcCv}> : () -> !llvm.ptr
    %25 = "taskflow.definition"(%cast_5, %24) : (memref<?xi8>, !llvm.ptr) -> memref<?xi8>
    %26 = "polygeist.pointer2memref"(%24) : (!llvm.ptr) -> memref<?x!llvm.func<void ()>>
    %27 = call @_ZN11taskflowLib15task_definitionEPvPFvvE(%cast, %cast_5, %26) : (memref<?x2xmemref<?xi8>>, memref<?xi8>, memref<?x!llvm.func<void ()>>) -> memref<?xi8>
    "taskflow.precede"(%27, %23) : (memref<?xi8>, memref<?xi8>) -> ()
    call @_ZN11taskflowLib14add_dependencyEPvS0_(%cast, %27, %23) : (memref<?x2xmemref<?xi8>>, memref<?xi8>, memref<?xi8>) -> ()
    "taskflow.precede"(%23, %19) : (memref<?xi8>, memref<?xi8>) -> ()
    call @_ZN11taskflowLib14add_dependencyEPvS0_(%cast, %23, %19) : (memref<?x2xmemref<?xi8>>, memref<?xi8>, memref<?xi8>) -> ()
    taskflow.execute
